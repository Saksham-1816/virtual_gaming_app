...
class _CoinScreenState extends State<CoinScreen> {
  ...
  Future<void> _flip() async {
    ...
    await coin.play(user.id, betAmount: amount);

    if (!mounted) return;

    await context.read<WalletProvider>().initializeWallet(user.id);
  }
  ...
  Widget build(BuildContext context) {
    return Consumer3<CoinProvider, WalletProvider, AuthProvider>(
      builder: (context, coinProvider, walletProvider, authProvider, child) {
        ...
        final possiblePayout = (betAmount * multiplier).round();

        final profit = possiblePayout - betAmount;
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: [Color(0xFF6C1DFF), Color(0xFFB52CFF)],
                        ),
                      ),
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: coinProvider.chooseHeads
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 18,
                                    fontWeight: coinProvider.chooseHeads
                                        ? FontWeight.bold
                                        : FontWeight.normal,
                                  ),
                                ),
                ...
                _sectionCard(
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextField(
                                      ...
                                      enabled: !coinProvider.isPlaying,
                                      ...
                                      onChanged: (value) {
                                        ...
                                        if (amount != null) {
                                          coinProvider.setBetAmount(amount);
                                          setState(() {});
                                        }
                                      },
                                    ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: coinProvider.isPlaying ? null : _flip,
                              style: ElevatedButton.styleFrom(
                                backgroundColor: purple,
                                disabledBackgroundColor: purple.withOpacity(.4),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(16),
                                ),
                              ),
                              child: coinProvider.isPlaying
                                  ? const SizedBox(
                                      width: 22,
                                      height: 22,
                      ...
                      Row(
                        children: [
                          _quickBet(10, betAmount, _setBet),
                          _quickBet(50, betAmount, _setBet),
                          _quickBet(100, betAmount, _setBet),
                          _quickBet(500, betAmount, _setBet),
                          _quickBet(1000, betAmount, _setBet, label: '1K'),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [Color(0xFF0B271B), Color(0xFF07150F)],
                          ),
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: Colors.greenAccent.withOpacity(.55),
                          ),
                        ),
                        child: Row(
                          children: [
                      ...
                      _infoRow(Icons.percent, 'Win Chance', '$winChance%'),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected ? const Color(0xFF8B2CFF) : Colors.white12,
  ...
  Widget _infoRow(IconData icon, String title, String value) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: const Color(0xFF9D43FF), size: 22),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
              title,
